/**
 * The form of the "Apply article template" menu item.
 *
 * Applying a template overwrites the summary and the content, so the warning is rendered upfront
 * and a single click applies -- there is no second confirmation step.
 */
